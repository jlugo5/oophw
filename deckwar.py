...
for x in range(26):
    player_one.add_cards(new_deck2.deal_one())
    player_two.add_cards(new_deck2.deal_one())
...
while game_on:
    ...
    player_one_cards = []
    player_one_cards.append(player_one.remve_one())

    player_two_cards = []
    player_two_cards.append(player_two.remve_one())
    ...
    while at_war:
        ...
        if player_one_cards[-1].value > player_two_cards[-1].value:
            ...
            if len(player_one.all_cards) < 3:
                print("Player One unable tp declare war")
